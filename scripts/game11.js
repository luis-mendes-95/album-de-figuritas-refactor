...
const game11 = () => {
  ...
  //APENAS PARA PULAR PARA O JOGO 12//
...
//********************************AQUI */
  ...
  const renderResult = () => {
      ...
      const lorenzo_correct_game11 = document.createElement("img");
      lorenzo_correct_game11.classList.add("lorenzo_correct_game11");
      lorenzo_correct_game11.src = "../assets/lorenzo/lorenzo_ok1.png";
      ...
      container.append(lorenzo_correct_game11, continue_button);
  ...
  const placeToyInputs = () => {
    ...
    setTimeout(() => {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            divImgAnimalGame11.style.backgroundImage = "url('../assets/book_details/figanimals.svg')";
            ...
            divImgName.style.backgroundImage = "url('../assets/book_details/figanimals.svg')";
            ...
            //imgAnimal.style.maxWidth = "80%";
            //imgAnimal.style.maxHeigth = "80%"
            imgNameBackground.src = "../assets/book_details/figanimals.svg";
            ...
            //IMAGEM DO ANIMAL QUE SERÁ INSERIDA NA FIGURINHA - INICIO//
              ...
              imgPicAnimal.src = `../assets/animals/${arrayNovo[i]}.svg`;
    ...
    const memoryGameInitializeFull = () => {
      ...
      for (let i = 0; i < 6; i++){
        ...
        backgroundToChange.addEventListener("click", () => {
          backgroundToChange.style.backgroundImage = `url("../assets/book_details/figanimals.svg")`;
        ...
        element_par.addEventListener("click", () => {
          element_par.style.backgroundImage = `url("../assets/book_details/figanimals.svg")`;
