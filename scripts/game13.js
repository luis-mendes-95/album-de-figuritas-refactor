...
const game13 = () => {
  ...
  //APENAS PARA PULAR PARA O JOGO 13//
    ...
    const lorenzo_start_game_11 = document.createElement("img")
    lorenzo_start_game_11.classList.add("lorenzo_start_game_11")
    lorenzo_start_game_11.src = "../assets/lorenzo/lorenzo_memoria.png"

    container.append(lorenzo_start_game_11)

    //RENDERIZA O BOTÃO DE CONTINUAR PARA A FASE - INICIO//
    const button_continue_start = document.createElement("img");
    button_continue_start.classList.add("button_continue_start");
    button_continue_start.src = "../assets/botoes/bt_continua.png"
    container.appendChild(button_continue_start);  
...
//********************************AQUI */
  ...
  const renderResult = () => {
      ...
      const lorenzo_correct_final = document.createElement("img");
      lorenzo_correct_final.classList.add("lorenzo_correct_final");
      lorenzo_correct_final.src = "../assets/lorenzo/lorenzo_final.png";

      const continue_button = document.createElement("img");
      continue_button.classList.add("button_continue_game11");
      continue_button.src = "../assets/botoes/bt_reinicia_hover.png";
      ...
      const lorenzo_start_game_11 = document.querySelector(".lorenzo_start_game_11");
      if (lorenzo_start_game_11) {
        lorenzo_start_game_11.parentNode.removeChild(lorenzo_start_game_11)
      }
      ...
      container.append(lorenzo_correct_final, continue_button);
  ...
  const placeToyInputs = () => {
    ...
    setTimeout(() => {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            divImgAnimalGame11.style.backgroundImage = "url('../assets/book_details/figtransports.svg')";
            ...
            divImgName.style.backgroundImage = "url('../assets/book_details/figtransports.svg')";
            ...
            //imgAnimal.style.maxWidth = "80%";
            //imgAnimal.style.maxHeigth = "80%"
            imgNameBackground.src = "../assets/book_details/figtransports.svg";
            ...
            //IMAGEM DO ANIMAL QUE SERÁ INSERIDA NA FIGURINHA - INICIO//
              ...
              imgPicAnimal.src = `../assets/veiculos/${arrayNovo[i]}.svg`;
            ...
            divSlotTransportsgame8.appendChild(divImgName);
            //divSlotTransportsgame8.appendChild(divImgName);
    ...
    const memoryGameInitializeFull = () => {
      ...
      for (let i = 0; i < 6; i++){
        ...
        backgroundToChange.addEventListener("click", () => {
          backgroundToChange.style.backgroundImage = `url("../assets/book_details/figtransports.svg")`;
        ...
        element_par.addEventListener("click", () => {
          element_par.style.backgroundImage = `url("../assets/book_details/figtransports.svg")`;
  ...
  button_continue_start.addEventListener("click", () => {
    lorenzo_start_game_11.parentNode.removeChild(lorenzo_start_game_11);
    button_continue_start.parentNode.removeChild(button_continue_start);
